...
img1 = cv2.imread('C:/Users/Jared/Documents/python_scripts/test1_segmented_images_left/rectified_left_12.png', 0)
img2 = cv2.imread('C:/Users/Jared/Documents/python_scripts/test1_segmented_images_right/rectified_right_12.png', 0)
...
for i, (m1, m2) in enumerate(matches):
    if m1.distance < .9 * m2.distance:
        ...
        pt2 = kpts2[m1.trainIdx].pt1
        if pt1 != pn1 and pt2 != pn2:
            if abs(pt2[1] - pt1[1]) < 6:
                if (gray1.item(int(pt1[1]), int(pt1[0])) >= 0 and gray2.item(int(pt2[1]), int(pt2[0])) >= 0):
                    pn1 = pt1
                    pn2 = pt2
                    print(sc, pn1, pn2)
                    sc += 1
